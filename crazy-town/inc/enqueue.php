...
function theme_styles()
{
    ...
    wp_register_style('swiper-bundle', get_template_directory_uri() . '/assets/css/swiper-bundle.min.css', '', '1', 'all');
...
function theme_script() {
    ...
    wp_enqueue_script('swiper-bundle', get_template_directory_uri() . '/assets/js/swiper-bundle.min.js', array(), '', true);
